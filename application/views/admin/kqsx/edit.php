                            ...
                            <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" id="param_kq"
                                                   value="<?php echo $info->ketqua ?>" name="param_kq"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control"
                                                   value="<?php echo $info->ketquatong ?>" id="param_tong"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control"
                                                   value="<?php echo $info->tong ?>" id="param_ddtong"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control"
                                                   value="<?php echo $info->hieu ?>" id="param_ddhieu"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control"
                                                   value="<?php echo $info->dontong ?>" id="param_dontong"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control"
                                                   value="<?php echo $info->donhieu ?>" id="param_donhieu"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control"
                                                   value="<?php echo $info->status ?>" id="param_status"
                                                   name="param_status">
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <label style="color: red"><?php echo form_error('param_status') ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="input-group date" id="datetimepicker2">
                                                <input type="text" class="form-control" id="toDate" name="toDate"
                                                       value="<?php echo $info->creatdate ?>"><span
